 ...
 */
public final class WeatherSchedulerTask extends TimerTask {

    public static WeatherSchedulerTask getInstance = new WeatherSchedulerTask();

    private WeatherSchedulerTask() {
    }
